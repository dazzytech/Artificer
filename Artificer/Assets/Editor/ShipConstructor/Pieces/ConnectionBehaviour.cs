...
namespace Editor
{
    public class ConnectionBehaviour : ScriptableObject {
        ...
        public void Confirm()
        {
            ConfirmConnections ();                          // confirm pending sockets
        }
    	...
    	private bool FindConnectingObjects()
    	{
                     ...
                     in collidedObjects)
    		{
    			...
    			PiecesUtility.ApplyDirection(direction, 			// retreive list of sockets that are
    	...
    	/// </summary>
    	public void ConfirmConnections()
    	{
    		foreach (SocketBehaviour socket in 
    		         socketsToConfirm) {
