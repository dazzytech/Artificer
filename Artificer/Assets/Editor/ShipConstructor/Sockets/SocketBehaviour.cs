...
{
    public class SocketBehaviour : ScriptableObject {

    	private SocketAttributes _attributes;
    	private SocketEventController _event;
        BaseShipComponent _base; 

    	// Use this for initialization
    	public void Init (BaseShipComponent home) {
            _base = home;
    	...
    	public Vector2 position
    	{
            ...
            { 
                if(_attributes == null)
                    return  _base.Bounds.position;
                return _base.Bounds.position + _attributes.position;
            }
            set
            {
    	...
    	public BaseShipComponent container
    	{
    		get { return _base;}
    	}
        ...
        {
            get { return _attributes.objectID;}
            set { _attributes.objectID = value;}
        }
