...
namespace Space.UI.Station.Editor
{
    public class ConnectionBehaviour {
        ...
        public List<BaseComponent> collidedObjects;
        public List<BaseComponent> otherPieces;
    	...
    	public void Init (List<SocketBehaviour> socks) {
            ...
            collidedObjects = new List<BaseComponent>();
    		otherPieces = new List<BaseComponent> ();
    	}
